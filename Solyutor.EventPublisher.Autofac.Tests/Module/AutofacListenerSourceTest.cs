...
namespace Solyutor.EventPublisher.Autofac.Tests.Module
{
    ...
    public class AutofacListenerSourceTest
    {
        ...
        public void Resolve_returns_transient_instances_from_kernel()
        {
            ...
            builder.RegisterType<TestPerDependencyListener>().AsImplementedInterfaces();
            ...
            Assert.That(listenters.OfType<IPerDependencyListener<TestMessage>>().Count(), Is.EqualTo(1));
        }
    }
}